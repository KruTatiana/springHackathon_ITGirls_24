const quotes = [
    ...
    {
        "quote": "Самое важное - это верить в себя. Если ты веришь в себя, то все возможно",
        "autor": " Мэри Кэй Аш"
      },
      {
        "quote": "Никогда не позволяй никому сказать тебе, что ты не можешь сделать чего-то. Если у тебя есть мечта, защищай её.",
        "autor": "Габби Дуглас"
      },
      {
        "quote": "Самое важное в жизни - это умение принимать вызовы и не бояться перемен",
        "autor": "Мэй Уэст"
      },
      {
        "quote": "Женщина может достичь всего, если она верит в себя и не боится рисковать.",
